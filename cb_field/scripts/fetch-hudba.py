"""Pořizovací skript: doména HUDBA z české Wikipedie.

Spuštění:  ./run-python cb_field/scripts/fetch-hudba.py
...
fixovaný korpus data-persistent/korpus/korpus-202.json. Text je licencovaný
...
Výchozí bod je článek „Hudba“, ARTICLES pak vyjmenovává jeho klíčová
...
by první velký článek (Hudba, Orchestr…) celý rozpočet a zbytek by nedostal
žádný prostor.
"""
...
USER_AGENT = ("conBond3-cb_field/1.0 (fetch-hudba.py; one-off download "
              "of a measurement corpus; contact: see ZDROJ.md in repo)")

TARGET = (Path(__file__).resolve().parents[1]
          / "data-persistent" / "korpus" / "korpus-202.json")

# Hudba a její klíčová navazující témata (zadání J. 2026-08-04). Pořadí je
